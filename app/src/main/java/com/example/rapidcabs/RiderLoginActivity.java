...
public class RiderLoginActivity extends AppCompatActivity implements View.OnClickListener, View.OnKeyListener {
    ...
    public void onClick(View view) {
        if(view.getId() == R.id.loginTextView){
            if(signupModeActive){
                ...
                signupButton.setText("LOGIN AS RIDER");
                loginTextView.setText("Not having an account? Create One");
            }
            else{
                signupModeActive = true;
                signupButton.setText("SIGN UP AS RIDER");
    ...
    public void signUp(View view) {
        if (usernameEditText.getText().toString().matches("") || passwordEditText.getText().toString().matches("")) {
            Toast.makeText(RiderLoginActivity.this, "A username and a password is required", Toast.LENGTH_SHORT).show();
        }
        else {
            if (signupModeActive) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView cabsImageView  = (ImageView)findViewById(R.id.cabsImageView);
        ConstraintLayout backgroundLayout = (ConstraintLayout) findViewById(R.id.backgroundLayout);
        cabsImageView.setOnClickListener(this);
